    ...
    def prepare_payload_for_netsuite_quote
     {
      ...
      "contact": { id: associated_contact_details[:netsuite_contact_id][:value] },
      "memo": "Quote for HubSpot Deal: Test Deal",
      "opportunity": { "id": @netsuite_opportunity_id, "type": "opportunity" },
