module Hubspot
  class QuoteDeal < Hubspot::Base
    ...
    def associate_company
      ...
      @client.create_association("deals", "companies")
    end
    ...
    def associate_line_item
      ...
      @client = Hubspot::Client.new(body: body)
      @client.create_association("line_items", "deals")
    end
  end
end
